...
public class ImgValidateServlet extends HttpServlet {
    ...
    // 定义验证码的字符表
    private static final String[] VALIDATE_CHAR_LIB = {"A", "B", "C", "D", "E", "F", "G", "H", "K", "L", "M", "N", "P",
            "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "2", "3", "4", "5", "6", "8", "9"};
    // 定义认证码的字体表
    private static final String[] FONT_TYPES = {"Courier New", "arial", "Times New Roman", "Viner Hand ITC", "Papyrus",
            "Courier New", "Viner Hand ITC", "Papyrus", "Courier New", "Viner Hand ITC", "Papyrus"};
    // 定义认证码的字体风格表
    private static final int[] FONT_STYLES = {Font.BOLD, Font.BOLD, Font.BOLD, Font.BOLD, Font.PLAIN, Font.ITALIC,
            Font.PLAIN, Font.ITALIC, Font.PLAIN};
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 根据当前图片大小，随机生成每个数字位置
        int[][] posDigital = drawRands(g, random);
        ...
        for (int i = 0; i < LENGTH; i++) {
            ...
            s.append(rand);
            // 设定字体
            g.setFont(new Font(FONT_TYPES[random.nextInt(FONT_TYPES.length)], FONT_STYLES[random
                    .nextInt(FONT_STYLES.length)], 28));
